...
| [F023 LLM Semantic Auditor](F023-llm-semantic-auditor.md) | LLM-backed semantic audit, entailment, overreach, auditor fallback | LLM auditor, semantic_auditor, llm_overreach, llm_unsupported, llm_source_mismatch, llm_insufficient_evidence, Case C | `ScienceClaw/backend/research_assistant/audit.py`; `ScienceClaw/backend/research_assistant/answering.py`; `ScienceClaw/backend/research_assistant/evaluation.py`; `ScienceClaw/backend/research_assistant/golden_eval.py`; `ScienceClaw/backend/route/sessions.py`; `ScienceClaw/backend/scripts/research_ui_e2e.py`; `docs/evals/research_golden_cases.json` | 修改 LLM-backed claim entailment auditor、LLM audit fallback metadata、LLM-required quality gate、semantic overreach live UI Case C 前。 |
| [F024 Evidence Matrix Literature Review](F024-evidence-matrix-literature-review.md) | evidence matrix, literature review, multi-paper report | evidence matrix, literature review, 7 papers, matrix artifact, report sidecar, Case D | `ScienceClaw/backend/research_assistant/answering.py`; `ScienceClaw/backend/research_assistant/reports.py`; `ScienceClaw/backend/research_assistant/evaluation.py`; `ScienceClaw/backend/research_assistant/golden_eval.py`; `ScienceClaw/backend/route/sessions.py`; `ScienceClaw/backend/scripts/research_ui_e2e.py`; `ScienceClaw/frontend/src/pages/ChatPage.vue`; `docs/evals/research_golden_cases.json`; `paper_data/f024_7paper_corpus/` | 修改 7 篇以上多论文 literature review、Evidence Matrix artifact、report sidecar、matrix/report quality gate 或 live UI Case D 验收前。 |
| [F025 Reproducible Demo Validation Chain](F025-reproducible-demo-validation-chain.md) | demo validation, one-command eval, reproducible evidence chain | F025, demo validation, validation chain, quick mode, full mode, Case C, Case D, golden eval corpus, interview demo | `ScienceClaw/backend/scripts/research_demo_validation.py`; `ScienceClaw/backend/tests/test_research_demo_validation.py`; `ScienceClaw/backend/scripts/research_golden_eval.py`; `ScienceClaw/backend/scripts/research_ui_e2e.py`; `docs/evals/research_golden_cases.json`; `docs/evals/payloads/`; `paper_data/f024_7paper_corpus/` | 需要运行或修改一键 Demo/Validation 链、扩展 golden eval payload corpus、调整 quick/live/full orchestration、或生成面试验收报告前。 |
